...
<!-- weights:start -->
_Mirrored from upstream commit `b089ce6` (2026-08-17); `param.rs` header says last production sync **2026-08-12T04:09:22Z**; extracted 2026-08-18. Weights multiply the viewer's **predicted probability** of the action, not raw counts._
...
| video quality view (>10 s, viewer <10k followers) | `VqvWeight` | **0.05** | `home-mixer/params/param.rs:343` |
| photo expand | `PhotoExpandWeight` | **0.05** | `home-mixer/params/param.rs:323` |
| video open | `VideoOpenWeight` | **0.05** | `home-mixer/params/param.rs:329` |
...
| dwell (binary) | `DwellWeight` | **0** | `home-mixer/params/param.rs:357` |
